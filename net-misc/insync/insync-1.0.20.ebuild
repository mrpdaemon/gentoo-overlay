...
SRC_URI="
	...
	gnome? ( http://s.insynchq.com/builds/insync-nautilus_${PV}_all.deb )
	kde?   ( http://s.insynchq.com/builds/insync-dolphin_${PV}_all.deb )
	xfce?  ( http://s.insynchq.com/builds/insync-thunar_${PV}_all.deb ) "
